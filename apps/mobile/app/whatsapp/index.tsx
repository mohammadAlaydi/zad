...
import { View, Text, Pressable, ScrollView, StyleSheet, StatusBar, Switch } from "react-native";
...
const COMMANDS = [
  {
    cmd: "balance",
    desc: "Check your wallet balance in any currency",
            ...
            {[
              {
                ...
                desc: "Get notified of balance changes",
                value: balanceNotif,
                toggle: setBalanceNotif,
              },
              {
                label: "Transaction Alerts",
                desc: "Real-time send/receive notifications",
                value: txNotif,
                toggle: setTxNotif,
              },
              {
        ...
        <View style={styles.securityNote}>
          ...
          <View style={{ flex: 1, marginLeft: 12 }}>
            ...
            <Text style={styles.secDesc}>
              Your WhatsApp number is verified and bound to your ZADPay account via OTP. All
              commands require identity confirmation for transactions above $100.
            </Text>
          </View>
        </View>
      </ScrollView>
