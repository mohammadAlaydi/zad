...
export default function Home() {
  ...
  const services = [
    {
      key: "topUp",
      icon: <FontAwesome5 name="wallet" size={20} color={Colors.brand.primary} solid />,
      route: "/topup",
      highlight: false,
    },
    {
      key: "send",
      icon: <Ionicons name="paper-plane" size={20} color={Colors.brand.primary} />,
      route: "/send",
      highlight: false,
    },
    {
      key: "receive",
      icon: <MaterialCommunityIcons name="cash-multiple" size={20} color={Colors.brand.primary} />,
      route: "/receive",
      highlight: false,
    },
    {
      key: "qrScan",
      icon: <MaterialCommunityIcons name="qrcode-scan" size={20} color={Colors.brand.primary} />,
      route: "/qr",
      highlight: false,
    },
  ];
                ...
                return (
                  <Pressable
                    ...
                    style={{
                      ...
                      borderRadius: 12,
                      marginBottom: 6,
                      backgroundColor: isActive ? Colors.brand.primary50 : "transparent",
                    }}
                  >
                    ...
                    <Text
                      style={{
                        ...
                        fontSize: 15,
                        color: isActive ? Colors.brand.primary : Colors.ink[700],
                      }}
                    >
                      {c}
                    </Text>
