        ...
        >
          ...
          {[
            ...
            >
              ...
              >
                <Text
                  style={{ color: Colors.brand.primary, fontFamily: "Inter_700Bold", fontSize: 14 }}
                >
                  {s.step}
                </Text>
              </View>
          ...
          <View style={{ marginTop: 24 }}>
            <Button
              ...
              onPress={() =>
                Alert.alert(
                  "Report Submitted",
                  "Your fraud report has been submitted. Our team will contact you within 24 hours.",
                )
              }
            />
          </View>
