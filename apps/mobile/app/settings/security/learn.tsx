...
const TIPS = [
  {
    ...
    body: "Avoid simple PINs like 123456. Use a mix of numbers.",
  },
  {
    icon: "eye-off-outline" as const,
    title: "Never share your password",
    body: "ZADPAY will never ask for your password via phone or email.",
  },
  {
    icon: "notifications-outline" as const,
    title: "Enable notifications",
    body: "Stay informed about every transaction on your account.",
  },
  {
    icon: "wifi-outline" as const,
    title: "Avoid public Wi-Fi",
    body: "Don't access ZADPAY on unsecured public networks.",
  },
  {
    icon: "finger-print-outline" as const,
    title: "Enable biometrics",
    body: "Face ID or fingerprint keeps your account safer and faster.",
  },
];
