  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 240 240" fill="none">
      <G stroke="#1B1F36" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" fill="none">
        ...
        <Rect x={96} y={118} width={48} height={8} rx={4} fill="#1FCFA5" stroke="none" opacity={0.3} />
        <Rect x={96} y={118} width={32} height={8} rx={4} fill="#1FCFA5" stroke="none" />
        <Rect x={96} y={132} width={48} height={8} rx={4} fill="#5B2C9C" stroke="none" opacity={0.15} />
        <Rect x={96} y={132} width={40} height={8} rx={4} fill="#5B2C9C" stroke="none" opacity={0.4} />
        ...
        <Path d="M34 122 V132 M30 125 C30 123 38 123 38 125 C38 127 30 129 30 131 C30 133 38 133 38 131" strokeWidth={1} />
        
        {/* Top-right note */}
        <Rect x={192} y={104} width={28} height={18} rx={3} strokeWidth={1.5} />
        <Path d="M206 108 V118 M202 111 C202 109 210 109 210 111 C210 113 202 115 202 117 C202 119 210 119 210 117" strokeWidth={1} />
        ...
        <Path d="M192 88 L194 84 L196 88 L200 90 L196 92 L194 96 L192 92 L188 90 Z" strokeWidth={1} fill="#5B2C9C" opacity={0.4} />
        <Path d="M44 52 L46 48 L48 52 L52 54 L48 56 L46 60 L44 56 L40 54 Z" strokeWidth={1} fill="#1FCFA5" opacity={0.4} />
