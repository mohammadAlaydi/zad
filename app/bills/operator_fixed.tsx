  ...
  return (
    <Screen bg={Colors.white} keyboard>
      ...
      >
        ...
        >
          <View style={{ flexDirection: "row", alignItems: "center", flex: 1, paddingHorizontal: 14 }}>
            <Text style={{
      ...
      <View style={{ position: "absolute", left: 18, right: 18, bottom: insets.bottom + 12 }}>
        <Button
          ...
          onPress={() => router.push({ pathname: "/bills/pay", params: { operator: selectedOperator, phone: phone || "07XX XXX XXXX", service: service || services[0] } })}
        />
      </View>
    </Screen>
  );
