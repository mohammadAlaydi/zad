          ...
          >
            <Pressable
              ...
              style={({ pressed }) => ({
                ...
                borderWidth: 1, borderColor: Colors.ink[100], marginBottom: 10,
                opacity: pressed ? 0.85 : 1,
                shadowColor: "#101225", shadowOpacity: 0.02, shadowRadius: 5, shadowOffset: { width: 0, height: 2 },
              })}
            >
              <View style={{
                width: 42, height: 42, borderRadius: 12, backgroundColor: cat.color + "18",
